# Generated by Django 2.1.3 on 2019-06-26 07:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('CustomerAccount', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='CustomerAcnt', to='core.Account')),
                ('PurchaseAccont', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PurchaseAcnt', to='core.Account')),
                ('SalesAccont', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='SalesAcnt', to='core.Account')),
                ('SupplierAccount', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='SupplierAcnt', to='core.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Area',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CreditAcct', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='CreditAcct', to='core.Account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Area')),
